...
THREEx.createPoolBall = function (opts) {
    ...
    opts.sphereR = opts.sphereR !== undefined ? opts.sphereR : 0.5
    ...
    if (opts.ballDesc === 'cue') {
        ...
        var fillStylePerDesc = {
            ...
            '13': "#F87217", // Orange
            '14': "#348017", // Green
            '15': "#A52A2A", // Brown or burgundy (tan in some ball sets)
    ...
    var geometry = new THREE.SphereGeometry(opts.sphereR, opts.textureW/2, opts.textureW/2)
